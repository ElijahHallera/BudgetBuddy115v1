...
public class createPersonalMonthlyBudget extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_create_personal_monthly_budget);
        ...
        presetButton = (RadioButton) findViewById(R.id.radioButton1); //Annual
        customButton = (RadioButton) findViewById(R.id.radioButton2); //Monthly
        ...
        returnHome.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(createPersonalMonthlyBudget.this, MainActivity.class);
        ...
        generateBudget.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(selectedType.equals("preset")){
                    Intent intent = new Intent(createPersonalMonthlyBudget.this, personalBudget.class);
                    String s = "";
                    ...
                    Intent intent = new Intent(createPersonalMonthlyBudget.this, CustomPersonalBudget.class);
                    String s = "";
                    if (income.getText().toString().isEmpty()) {
                        // if no income was put we'll use default value of 40000
                        s += "40000";
